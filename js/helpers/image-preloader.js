function ImagePreloader (allImagesLoadedCallback)
{
	...
	{
		// log ("ImagePreloader:: imageLoaded... src: " + this.src);

		_totalImagesLoading--;

		// log ("ImagePreloader:: [imageLoaded] _totalImagesLoading: " + _totalImagesLoading);
	...
	function preloadImage (imageURL)
	{
		...
		{
			// log ("ImagePreloader:: [preloadImage] imageURL is not defined, or is an empty string... forcing 'imageLoaded' method and returning.");
			imageLoaded ();
			return;
		}

		// log ("ImagePreloader:: [preloadImage]... url:" + imageURL);
